...
export default function SetupProfilePage() {
    ...
    if (loading) return <div style={{ textAlign: 'center', marginTop: '100px', fontWeight: '600' }}>Loading profile configurations...</div>;
    ...
    return (
        <div style={{ maxWidth: '550px', margin: '50px auto', padding: '30px', background: '#fff', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' }}>
            <h2 style={{ textAlign: 'center', marginBottom: '10px', color: '#1e2a2f', fontWeight: '800' }}>Complete Your Profile</h2>
            <p style={{ textAlign: 'center', color: '#7a6a58', marginBottom: '30px', fontWeight: '500' }}>
                Setup your professional details as a <span style={{ color: '#0b5b2f', fontWeight: '700', textTransform: 'uppercase' }}>{userType}</span>
            </p>

            <form onSubmit={handleSaveProfile}>
                <div style={{ marginBottom: '16px' }}>
                    <label style={{ display: 'block', marginBottom: '6px', fontWeight: '500' }}>Contact Phone Number</label>
                    <input 
                        type="tel" 
                        required 
                        placeholder="+964..."
                ...
                <div style={{ marginBottom: '20px' }}>
                    <label style={{ display: 'block', marginBottom: '6px', fontWeight: '500' }}>Bio / Overview</label>
                    <textarea 
                        required 
                        rows="4"
                ...
                {userType === 'company' && (
                    <div style={{ background: '#fcfaf7', padding: '20px', borderRadius: '12px', marginBottom: '24px', border: '1px dashed #e1d5c6' }}>
                        ...
                        <div style={{ marginBottom: '12px' }}>
                            <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.9rem', fontWeight: '500' }}>WhatsApp Number (Format: 9647XXXXXXXX)</label>
                            <input 
                                type="text" 
                        ...
                        <div style={{ marginBottom: '12px' }}>
                            <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.9rem', fontWeight: '500' }}>Facebook Profile URL</label>
                            <input 
                                type="url" 
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: '4px', fontSize: '0.9rem', fontWeight: '500' }}>LinkedIn Company URL</label>
                            <input 
                                type="url" 
